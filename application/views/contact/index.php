...
<main>
    <div class="container contact-box bg-color1 py-5">
        <div class="row">
            <div class="col-12 py-5">
                <h2>Contact Us</h2>
            </div>
            <p class="col-11 col-md-9 col-lg-7 mx-auto">
                Please fill in the form below. We will personally contact you within 24 hours to answer your sales inquiries. We look forward to hearing from you
            </p>
        ...
        <div class="row text-start justify-content-center my-5 py-5 quattrocento-sans-font">
                        ...
                        <div class="row">
                            <div class="col-12 mt-4">
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-dark rounded-0 py-3"><strong>SEND</strong></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-lg-4 col-xl-2 ">
                <div class="row">
                    <div class="col-md-4 col-lg-12 px-lg-0 mb-4">
                        <strong>Contact Information</strong>
                        <ol class="list-unstyled mb-0 ">
                            <li>phone: 647.226.3118</li>
                            <li>email: info@CasaMorra.com</li>
                        </ol>
                    </div>
                    <div class="col-md-8 col-lg-12 px-lg-0 mb-4">
                        <strong class="font-italic">Office Location</strong>
                        <ol class="list-unstyled mb-0">
