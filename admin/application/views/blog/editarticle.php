...
<div class="main-content">
	...
	<div class="container">
		...
		<form method="post" role="form" action="<?=BASEURL?>blog/editarticle_action">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="form-group">
								<input type="text" class="form-control" name="title" placeholder="Enter a Title" value="<?=$article['title']?>">
							</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<select name="active" class="form-control" id="sbox-active">
								<option value="1" <?=($article['active']==1)?'selected':''?>>Yes</option>
								<option value="0" <?=($article['active']==0)?'selected':''?>>No</option>
							</select>
							...
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<div class="fileinput-new thumbnail" data-trigger="fileinput">
									<?php if($article['image']!= ''):?>
										<img id="image_file_image" src="<?=BASEURL?>../files/source/<?=$article['image']?>" alt="...">
									<?php else:?>
										<img id="image_file_image" src="http://placehold.it/259x100" alt="...">
									<?php endif;?>
								</div>
								<div>
									<input type="hidden" name="image_file_last" id="image_file_last" value="<?=$article['image']?>">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<select multiple="multiple" name="category[]" class="form-control" id="multi-category">
								<?php $article['category_ids'] = explode(', ', $article['category_ids']); ?>
								<?php foreach($category as $value): ?>
									<?php 
									$isSelected = false;
									foreach($article['category_ids'] as $_){
										if($_ == $value['id']) $isSelected = true;
									}
									?>
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<textarea class="form-control" rows="5" name="short_description" id="short_description"><?=$article['short_description']?></textarea>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<textarea class="form-control" rows="50" name="content" id="content"><?=$article['content']?></textarea>
						</div>
					</div>
				</div>
			</div>
