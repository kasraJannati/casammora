<nav class="navbar navbar-default navbar-sidebar bootsnav"><div class="scroller" style="height: 856px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#brand"><img src="<?=BASEURL?>public/images/ngen-logo.png" class="logo" alt="logo" width="100%" ></a>
			</div>
				...
				<ul class="nav navbar-nav" data-in="fadeInDown" data-out="fadeOutUp">
					...
					<li class="dropdown">
						...
						<ul>
							...
							<li><a href="<?=BASEURL?>property/commercial">Retail</a></li>
